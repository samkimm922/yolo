...
const PATH_GUARD_ALLOWLIST: Record<string, string> = {
  "src/runtime/adapters/evidence-collector.ts:220": "resolve(projectRoot, stateRoot, 'state/evidence/adapters', fileName) — internal output path under stateRoot from fixed segments; not an external-content read.",
};
