...
export const ATOMICITY_BATTERY: AtomicityBatteryCase[] = [
  ...
  { id: "multi-accept-or-decline-invitations", expect: "multi", text: "Allow users to accept or decline invitations." },
  ...
  { id: "multi-enable-or-disable-accounts", expect: "multi", text: "Admins can enable or disable accounts." },
