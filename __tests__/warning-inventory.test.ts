...
const SOURCE_ROOTS = ["src", "lib", "bin"];
const ROOT_ENTRYPOINTS = ["runner.ts", "gate.ts", "prompt.ts", "learn.ts", "sdk.ts"];

const INVENTORY = [
  ["lib/auto-fix.ts", { WARN: 0, warning: 1, "best-effort": 0, skip: 1 }],
  ["lib/evaluators/file-check.ts", { WARN: 0, warning: 0, "best-effort": 0, skip: 1 }],
  ["lib/evaluators/quality-check.ts", { WARN: 1, warning: 0, "best-effort": 0, skip: 0 }],
  ["lib/scanner-to-task.ts", { WARN: 1, warning: 0, "best-effort": 0, skip: 0 }],
  ["src/cli/gate.ts", { WARN: 4, warning: 0, "best-effort": 0, skip: 0 }],
  ["src/cli/prd-preflight.ts", { WARN: 0, warning: 1, "best-effort": 0, skip: 0 }],
  ["src/cli/prompt.ts", { WARN: 2, warning: 2, "best-effort": 0, skip: 0 }],
  ["src/cli/review.ts", { WARN: 0, warning: 0, "best-effort": 0, skip: 1 }],
  ["src/cli/yolo.ts", { WARN: 0, warning: 10, "best-effort": 0, skip: 5 }],
  ["src/core/bootstrap.ts", { WARN: 0, warning: 1, "best-effort": 0, skip: 4 }],
  ["src/core/setup.ts", { WARN: 0, warning: 4, "best-effort": 0, skip: 10 }],
  ["src/demand/gate.ts", { WARN: 0, warning: 24, "best-effort": 0, skip: 0 }],
  ["src/demand/interview.ts", { WARN: 0, warning: 4, "best-effort": 0, skip: 0 }],
  ["src/demand/runtime.ts", { WARN: 1, warning: 6, "best-effort": 0, skip: 0 }],
  ["src/discovery/artifacts.ts", { WARN: 1, warning: 5, "best-effort": 0, skip: 2 }],
  ...
  ["src/eval/benchmark.ts", { WARN: 0, warning: 6, "best-effort": 0, skip: 0 }],
  ["src/lifecycle/guard.ts", { WARN: 0, warning: 1, "best-effort": 0, skip: 0 }],
  ...
  ["src/prd/contract.ts", { WARN: 2, warning: 0, "best-effort": 0, skip: 0 }],
  ["src/prd/preflight.ts", { WARN: 1, warning: 47, "best-effort": 0, skip: 2 }],
  ["src/prd/spec-compiler.ts", { WARN: 0, warning: 2, "best-effort": 0, skip: 0 }],
  ["src/prd/validate.ts", { WARN: 0, warning: 4, "best-effort": 0, skip: 2 }],
  ...
  ["src/release/real-project-dogfood-pack.ts", { WARN: 0, warning: 0, "best-effort": 0, skip: 1 }],
  ...
  ["src/runtime/acceptance/report.ts", { WARN: 0, warning: 5, "best-effort": 0, skip: 0 }],
  ["src/runtime/adapters/agent-contract.ts", { WARN: 0, warning: 1, "best-effort": 0, skip: 2 }],
  ["src/runtime/adapters/provider-runtime-matrix.ts", { WARN: 0, warning: 9, "best-effort": 0, skip: 0 }],
  ["src/runtime/devtools/doctor.ts", { WARN: 0, warning: 7, "best-effort": 0, skip: 0 }],
  ...
  ["src/runtime/gates/check-report.ts", { WARN: 0, warning: 69, "best-effort": 0, skip: 0 }],
  ...
  ["src/runtime/gates/pre-execution-gates.ts", { WARN: 0, warning: 3, "best-effort": 0, skip: 0 }],
  ["src/runtime/gates/test-generation-validator.ts", { WARN: 0, warning: 1, "best-effort": 0, skip: 0 }],
  ...
  ["src/runtime/run-lifecycle/startup.ts", { WARN: 1, warning: 0, "best-effort": 0, skip: 0 }],
  ...
  ["src/runtime/runner-runtime.ts", { WARN: 0, warning: 0, "best-effort": 0, skip: 2 }],
...
const COVERAGE_RULES = [
  { prefix: "lib/", rationale: "Legacy evaluator/autofix warnings are allowed only as non-blocking diagnostics.", coveredBy: ["__tests__/engine.test.ts", "__tests__/deterministic-auto-fix.test.ts"] },
