...
const INVENTORY = [
  ...
  ["src/lifecycle/schema.ts", { WARN: 0, warning: 2, "best-effort": 0, skip: 0 }],
  ["src/lifecycle/state.ts", { WARN: 0, warning: 0, "best-effort": 0, skip: 3 }],
  ["src/packs/manifest.ts", { WARN: 0, warning: 4, "best-effort": 0, skip: 0 }],
  ["src/packs/resolver.ts", { WARN: 0, warning: 8, "best-effort": 0, skip: 0 }],
  ...
  ["src/runtime/evidence/report.ts", { WARN: 0, warning: 2, "best-effort": 0, skip: 23 }],
  // Fail-closed tri-state fingerprinting no longer describes unreadable declared files as skipped.
  ["src/runtime/evidence/source-fingerprint.ts", { WARN: 0, warning: 0, "best-effort": 0, skip: 1 }],
  ...
  ["src/runtime/execution/worktree-session.ts", { WARN: 1, warning: 0, "best-effort": 0, skip: 1 }],
  ["src/runtime/gates/check-report.ts", { WARN: 0, warning: 73, "best-effort": 0, skip: 0 }],
  ...
  ["src/runtime/gates/prd-contract-doctor.ts", { WARN: 4, warning: 2, "best-effort": 0, skip: 0 }],
  ...
  ["src/runtime/runner-core.ts", { WARN: 1, warning: 0, "best-effort": 0, skip: 0 }],
...
const COVERAGE_RULES = [
  ...
  { prefix: "src/runtime/adapters/", rationale: "Adapter warnings cover missing or unverifiable external provider evidence.", coveredBy: ["__tests__/agent-adapter-contract.test.ts", "__tests__/provider-runtime-matrix.test.ts", "__tests__/provider-capability-gate.test.ts"] },
  { prefix: "src/devtools/", rationale: "Doctor warnings are read-only diagnostics for project setup and integration.", coveredBy: ["__tests__/yolo-doctor.test.ts"] },
  ...
  { prefix: "src/runtime/gates/", rationale: "Gate warnings are structured non-pass states and must not become silent pass-throughs.", coveredBy: ["__tests__/check-report.test.ts", "__tests__/prd-contract-doctor-gate.test.ts", "__tests__/pre-execution-gates.test.ts", "__tests__/provider-capability-gate.test.ts"] },
  ...
  { prefix: "src/runtime/run-lifecycle/", rationale: "Run lifecycle skips preserve startup/finalize safety and state consistency.", coveredBy: ["__tests__/run-lifecycle-finalize.test.ts", "__tests__/run-lifecycle-startup.test.ts", "__tests__/run-lifecycle-state-files.test.ts", "__tests__/pre-execution-outcome.test.ts"] },
