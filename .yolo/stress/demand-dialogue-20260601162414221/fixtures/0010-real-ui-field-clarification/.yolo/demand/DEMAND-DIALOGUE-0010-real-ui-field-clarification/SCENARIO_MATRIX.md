# DEMAND-DIALOGUE-0010-real-ui-field-clarification Scenario Matrix
...
- SCN-001-SFC-001: 用户可见界面 (ui)
  ...
  - visual style: Use the existing project badge style and do not introduce a new color system.
