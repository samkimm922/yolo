# DEMAND-DIALOGUE-0001-real-ui-field-clarification Discussion Log

## Questioning Rounds
### Q01
- Question: What do you want to improve or clarify?
- Answer: 目标用户是店长/门店库存管理员；他们看库存列表时想加一个低库存提示，别影响下单导入。
...
- Answer: 文案就叫 Low stock，放在 SKU 后面，直接用当前列表字体做内联文本标签且不新增颜色；截图或组件测试能看到 affected SKU 有 badge 就可以。
