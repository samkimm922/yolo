# DEMAND-DIALOGUE-0001-real-ui-field-clarification Scenario Matrix
...
- SCN-001-SFC-001: 用户可见界面 (ui)
  ...
  - visual style: Use an inline text label with the current list typography and no new color system.
