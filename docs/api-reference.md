...
| `yolo/release/real-project-dogfood` | Real-project dogfood evidence gate for chat-driven `/yolo-plan`, `/yolo-check`, and `/yolo-review` on an external project with no code edits or provider execution. |
