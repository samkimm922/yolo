...
const WORKFLOWS: Record<string, WorkflowDescriptor> = {
  ...
  brainstorm: {
    ...
    preset: "planner",
    triggers: ["idea.received", "new_project.started", "cli.yolo-demand.brainstorm"],
    ...
    entrypoints: {
      ...
      cli: "yolo demand --stage brainstorm",
  ...
  discover: {
    ...
    preset: "planner",
    triggers: ["idea.received", "requirement.unclear", "cli.yolo-demand.discover"],
    ...
    entrypoints: {
      ...
      cli: "yolo demand --stage discover",
      skill: "yolo.discover",
    },
  },
  discuss: {
    ...
    preset: "planner",
    triggers: ["demand.needs_discussion", "requirement.gray_area", "cli.yolo-demand.discuss"],
  ...
  plan: {
    ...
    preset: "planner",
    triggers: ["discovery.ready", "plan.requested", "cli.yolo-tasks"],
  ...
  prd: {
    ...
    preset: "planner",
    triggers: ["plan.approved", "prd.requested", "cli.yolo-spec"],
